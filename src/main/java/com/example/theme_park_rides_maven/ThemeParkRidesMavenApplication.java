package com.example.theme_park_rides_maven;

import com.example.theme_park_rides_maven.entity.ThemeParkRide;
import com.example.theme_park_rides_maven.repository.ThemeParkRideRepository;
...
public class ThemeParkRidesMavenApplication {

	public static void main(String[] args) {
		SpringApplication.run(ThemeParkRidesMavenApplication.class, args);
	}
